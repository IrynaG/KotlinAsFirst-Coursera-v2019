 ...
 */
fun main() {
    val result = angleInRadian(36, 14, 60)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial.toDouble()*(percent.toDouble()/100+1).pow(3)
 ...
 */
fun numberRevert(number: Int): Int = 100*(number%10)+10*(number.div(10)%10)+number.div(10).div(10)
